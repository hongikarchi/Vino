...
public sealed partial class LiveDocumentBackend
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        const string stubSource = "// GPTino consolidation stub - the merged source lands after wiring.\n";
        ...
        CancellationToken cancellationToken)
    {
        ...
        foreach (var stage in meta.Stages)
        {
            ...
            const string stubSource = "// GPTino split stub - the stage source lands after wiring.\n";
