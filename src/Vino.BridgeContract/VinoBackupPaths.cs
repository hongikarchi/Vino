...
/// <summary>
/// The one place that knows where Vino writes its own pre-execute checkpoint copies.
///
/// <para>
/// Shared because two assemblies need the same answer for opposite reasons: Vino.Grasshopper
/// WRITES there, and Vino.Rhino must REFUSE to adopt anything under it as a document identity.
...
/// <c>RhinoAutoSavePaths</c> guards for Rhino's own autosave; Vino's copies need it too.
/// </para>
/// </summary>
public static class VinoBackupPaths
{
    /// <summary>Root of all Vino backups: %LOCALAPPDATA%\Vino\backups.</summary>
