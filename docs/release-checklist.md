...
- **미해결로 남긴 것:** GitHub 리포명은 아직 `hongikarchi/GPTino`라 **저장소 URL들은 의도적으로 구 이름 유지**(리포 rename 후 일괄 교체 — 사용자 승인 필요), 아이콘 실물(와인잔/코뿔소 시안 대기), 매니페스트 메타데이터(§3-3), 서명·태그·깨끗한 머신 설치 검증.
