...
public sealed class CSharpWatchdogInjectorTests
{
    ...
    public void ForLoopGainsPrologueAndLoopCheck()
    {
        ...
        Assert.Contains("__gptino_sw = System.Diagnostics.Stopwatch.StartNew()", injected, StringComparison.Ordinal);
        Assert.Contains("__gptino_i", injected, StringComparison.Ordinal);
    ...
    public void TypeDeclarationBodiesAreSkipped()
    {
        ...
        Assert.DoesNotContain("__gptino_", injected[helper..], StringComparison.Ordinal);
        Assert.Contains("__gptino_", injected[..helper], StringComparison.Ordinal);
        AssertParses(injected);
    }
    ...
    {
        var source = "var __gptino_sw = 1;\nfor (var i = 0; i < 10; i++)\n{\n    System.Console.WriteLine(__gptino_sw);\n}\n";
    ...
    public void ExpressionLambdaIsUntouchedButStatementLambdaIsGuarded()
    {
        ...
        Assert.DoesNotContain("__gptino_", injected.Substring(expressionLambda, 20), StringComparison.Ordinal);
    ...
    public void LeadingHeaderCommentStaysAboveTheGuardAndRoundTrips()
    {
        ...
        Assert.True(
            ...
            injected.IndexOf("__gptino_sw", StringComparison.Ordinal));
        Assert.Equal(source, CSharpWatchdogInjector.Strip(injected));
    }
